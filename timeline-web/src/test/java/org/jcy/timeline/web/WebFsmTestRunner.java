...
public class WebFsmTestRunner {

    private static final Logger log = LoggerFactory.getLogger(WebFsmTestRunner.class);

    private static final File RECORD_DIR = new File("E:\\@文件\\大学\\@毕业\\毕业论文\\data");
    private static final String FILE_SUFFIX = ".dot";

    private static final String DEFAULT_SUB_DIR = "timeline-web";
